...
public class VirtualButtonRenderer implements GLSurfaceView.Renderer, SampleAppRendererControl
{
    ...
    static private float RED_VB_BUTTON[] =  {-108.68f, -53.52f, -75.75f, -65.87f};
    static private float BLUE_VB_BUTTON[] =  {-45.28f, -53.52f, -12.35f, -65.87f};
    static private float YELLOW_VB_BUTTON[] =  {14.82f, -53.52f, 47.75f, -65.87f};
    static private float GREEN_VB_BUTTON[] =  {76.57f, -53.52f, 109.50f, -65.87f};
